...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("LinDicParatt_Sigma", (void (*)(void))__pyx_f_18Reflectivity_Sigma_LinDicParatt_Sigma, "__pyx_t_double_complex (struct __pyx_t_10Structural_Heterostructure *, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("LinDicParatt_Sigma_MS", (void (*)(void))__pyx_f_18Reflectivity_Sigma_LinDicParatt_Sigma_MS, "__pyx_t_double_complex (struct __pyx_t_10Structural_Heterostructure *, double, double)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_Reflectivity_Sigma(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'Reflectivity_Sigma' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "Reflectivity_Sigma")) {
      if (unlikely(PyDict_SetItemString(modules, "Reflectivity_Sigma", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init Reflectivity_Sigma", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
